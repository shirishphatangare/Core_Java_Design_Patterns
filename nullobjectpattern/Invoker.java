...
public class Invoker {
	...
	public Invoker(ICommand lightOnCommand,ICommand lightOffCommand,ICommand tvOnCommand,ICommand tvOffCommand,ICommand acOnCommand,ICommand acOffCommand,ICommand noCommand){
	...
	public void pressNoFunctionButton() {
		noCommand.execute();
		commandList.add(noCommand);
	}
